package slavara.as3.core.debug {
	...
	public final class Assert {
		...
		public static function isTrue(b:Boolean, message:String = ""):void {
			if(b) new Error(message);
		}
